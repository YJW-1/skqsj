...
if(!window.uinfo){
    window.uinfo = {gameid:100001,uid:openid,nick:'好友',icon:'',sex:0,city:'',country:'',province:'',from:'wechat'}; 
}
...
window.lieyou_getDataForKey = function(key,vauleDef = ""){
    var data = cc.sys.localStorage.getItem(key);
    if(data === null || data === "") {
        return vauleDef + "";
    }
