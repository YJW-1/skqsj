window.lieyou_icon_130_box = function(){
    ...
    lieyou_load('qgameMoreGame/texture/red', (err, texture) => {
...
window.lieyou_icon_130_circle = function(){
    ...
    lieyou_load('qgameMoreGame/texture/mask', (err, texture) => {
...
window.lieyou_moreGame_banner = function(){
    ...
    // view.getComponent(cc.Mask).type = cc.Mask.Type.RECT;
    content.x = -330;
    content.anchorX = 0;
    content.width = 0;
    content.height = 170;
    ...
    lieyou_load(title_banner2url, (err, texture) => {
    ...
    lieyou_load(bg_bannerurl, (err, texture) => {
    ...
    lieyou_load('qgameMoreGame/texture/bannerClose', (err, texture) => {
...
window.lieyou_moreGame_icon = function(){
    ...
    lieyou_load(bg_iconurl, (err, texture) => {
...
window.lieyou_moreGame_mid_one = function(type,haveTitle,titleType,scale){
    ...
    fNode.addChild(fNode2);
    // fNodeMaskZ.type = cc.Mask.Type.RECT;
    ...
    if(haveTitle && type != 3){//mid_titleZ_1
        if(titleType && type == 1){
            var titleBgWieth = 50;
            ...
            lieyou_load(titleUrl, (err, texture) => {
            ...
            lieyou_load(titlebgUrl, (err, texture) => {
...
window.lieyou_moreGame_more = function(){
    ...
    lieyou_load(bg_moreurl, (err, texture) => {
    ...
    lieyou_load(title_moreurl, (err, texture) => {
        if(err) return;
    ...
    lieyou_load(closerurl, (err, texture) => {
...
window.lieyou_moreGame_side = function(){
    ...
    lieyou_load(bg_2_side2url, (err, texture) => {
    ...
    lieyou_load(bg_sideurl, (err, texture) => {
    ...
    lieyou_load(title_sideurl, (err, texture) => {
        if(err) return;
    ...
    lieyou_load(bg_arrow_sideurl, (err, texture) => {
